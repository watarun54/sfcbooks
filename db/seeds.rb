...
satou = User.create(name: 'satou', email: 'satou@test.com', password: 'password')
suzuki = User.create(name: 'suzuki', email: 'suzuki@test.com', password: 'password')
tanaka = User.create(name: 'tanaka', email: 'tanaka@test.com', password: 'password')
test1 = User.create(name: 'test1',email: 'test1@test.com', password: 'password')
test2 = User.create(name: 'test2',email: 'test2@test.com', password: 'password')
